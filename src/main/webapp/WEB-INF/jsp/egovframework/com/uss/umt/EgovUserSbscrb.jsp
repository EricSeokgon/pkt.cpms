...
<%
 /**
  * @Class Name : EgovUserSbscrb.jsp
  * @Description : 사용자회원가입신청 JSP
  * @Modification Information
  * @
  * @  수정일         수정자                   수정내용
  * @ -------    --------    ---------------------------
  * @ 2013.06.21    이석곤          최초 생성
  *
  *  @author 피케이티 SI개발팀 이석곤 
  *  @since 2013.06.21
  *  @version 1.0
  *  @see
  *
...
<body>
<!-- content start -->
        <form:form commandName="userManageVO" action="${pageContext.request.contextPath}/uss/umt/EgovUserSbscrb.do" name="userManageVO" method="post" >
            <!-- 우편번호검색 -->
        ...
        <table width="717" border="0" cellpadding="0" cellspacing="1" class="table-register">
            ...
            <tr>
                <th width="20%" height="23" class="required_text"  >부서명&nbsp;&nbsp;</th>
                <td width="80%" >
                    <form:input path="ofcpsNm" id="ofcpsNm" title="부서명" cssClass="txaIpUmt" size="20" maxlength="50" />
            ...
            <tr>
                ...
                <table border="0" cellspacing="0" cellpadding="0" align="center">
		            <tr>
		                ...
		                <td>&nbsp;</td>
		                <td><span class="button">
		                <a href="javascript:document.userManageVO.reset();">취소</a></span></td>
		            </tr>
		        </table>
                </td>
            </tr>
