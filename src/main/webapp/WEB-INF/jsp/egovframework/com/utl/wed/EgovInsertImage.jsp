...
function __dlg_init(bottom) {
	...
	if (!document.all) {
		...
		if (navigator.userAgent.toLowerCase().indexOf("chrome") != -1) {	// chrome 경우는 alert()을 추가해 주어야만 사이징이 됨... 허허
			...
			self.resizeTo(body.offsetWidth + 30, body_height + 90);
		} else {
			self.resizeTo(body.offsetWidth + 30, body_height + 90);
		}
	} else {	// IE
...
<table width="100%" style="margin-bottom: 0.2em">
 <tr>
  <td valign="bottom">
    Image Preview:<br />
    <iframe name="ipreview" id="ipreview" frameborder="0" style="border : 1px solid gray;" height="200" width="300" src="" title="이미지 미리보기"></iframe>
  </td>
