...
public class EgovUserManageController {
    ...
    /**
     * 사용자회원가입신청 등록화면으로 이동한다.
     * @param userSearchVO 검색조건정보
     * @param userManageVO 사용자초기화정보
     * @param commandMap 파라메터전달용 commandMap
     * @param model 화면모델
     * @return cmm/uss/umt/EgovUserSbscrb
     * @throws Exception
     */
    @RequestMapping("/uss/umt/EgovUserSbscrbView.do")
    public String sbscrbUserView(
            @ModelAttribute("userSearchVO") UserDefaultVO userSearchVO,
            @ModelAttribute("userManageVO") UserManageVO userManageVO,
            Model model
            )throws Exception {
        ...
        return "egovframework/com/uss/umt/EgovUserSbscrb";
    }
    
    /**
     * 사용자회원가입신청등록처리후로그인화면으로 이동한다.
    ...
    /**
     * 사용자회원가입신청등록처리후로그인화면으로 이동한다.
     * @param userManageVO 사용자회원가입신청정보
     * @return forward:/uat/uia/egovLoginUsr.do
     * @throws Exception
     */
    @RequestMapping("/uss/umt/EgovUserSbscrb.do")
    public String sbscrbMber(
    		@ModelAttribute("userManageVO") UserManageVO userManageVO)
            throws Exception {
    	
    	//가입상태 초기화
    	userManageVO.setEmplyrSttusCode("A");
    	//그룹정보 초기화
